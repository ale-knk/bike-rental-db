...
def set_trips_df(split: str | None = None, **kwargs):
    ...
    **kwargs: Additional filtering parameters:
    ...
    trips_df['start_station_mongoid'] = trips_df['start_station_id'].map(mongo_id_mapping)
    trips_df['end_station_mongoid'] = trips_df['end_station_id'].map(mongo_id_mapping)
    ...
    trips_df.loc[train_end:val_end, 'split'] = 'val'
    trips_df.loc[val_end:, 'split'] = 'test'
